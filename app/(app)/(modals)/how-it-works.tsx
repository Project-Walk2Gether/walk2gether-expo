      ...
      >
        <YStack paddingHorizontal={20} alignItems="center">
          ...
          >
            <XStack marginBottom={20}>
              <YStack 
                ...
                marginRight={16}
              >
                <Text color="white" fontSize={18} fontWeight="bold">1</Text>
              </YStack>
              <YStack flex={1}>
                <Text 
                  fontSize={18} 
            ...
            <XStack marginBottom={20}>
              <YStack 
                ...
                marginRight={16}
              >
                <Text color="white" fontSize={18} fontWeight="bold">2</Text>
              </YStack>
              <YStack flex={1}>
                <Text 
                  fontSize={18} 
            ...
            <XStack marginBottom={20}>
              <YStack 
                ...
                marginRight={16}
              >
                <Text color="white" fontSize={18} fontWeight="bold">3</Text>
              </YStack>
              <YStack flex={1}>
                <Text 
                  fontSize={18} 
          ...
          <Button
            ...
            onPress={handleGotIt}
          >
            <Text color="#4EB1BA" fontWeight="bold" fontSize={18}>Got It!</Text>
          </Button>
        </YStack>
      </ScrollView>
    </LinearGradient>
