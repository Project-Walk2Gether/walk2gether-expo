            ...
            <YStack gap="$4" paddingVertical="$2">
              ...
              <YStack gap="$2" marginBottom="$4">
                ...
                <Text fontSize={14} color="$gray10" lineHeight={20}>
                  Markdown is a simple way to format text using special
                  characters. It lets you make text bold, italic, create lists,
                  and more without complex formatting tools. Just type the
                  special characters around your text and it will be formatted
                  automatically.
                </Text>
              </YStack>
              ...
              <YStack gap="$1">
                ...
                <Markdown style={{ body: { fontSize: 14 } }}>
                  **bold text**
                </Markdown>
              </YStack>
              ...
              <YStack gap="$1">
                ...
                <Markdown style={{ body: { fontSize: 14 } }}>
                  [Visit our website](https://walk2gether.com)
                </Markdown>
              </YStack>
              ...
              <YStack gap="$1">
                ...
                <Markdown
                  style={{ body: { fontSize: 14 } }}
                >{`> This is an inspiring quote`}</Markdown>
              </YStack>
              ...
              <YStack gap="$1">
                ...
                <Markdown style={{ body: { fontSize: 14 } }}>
                  Use the `join` command to participate
                </Markdown>
              </YStack>
            </YStack>
          </ScrollView>
