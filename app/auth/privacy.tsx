      ...
      <ScrollView>
        <YStack padding="$4" gap="$4" width={width}>
          ...
          <YStack gap="$2">
            <H3>Introduction</H3>
            <Paragraph>
              Welcome to ProjectWalk2gether.org ("we," "our," or "us"). We respect your privacy and are committed to protecting your personal data. This privacy policy will inform you about how we look after your personal data when you visit our website and tell you about your privacy rights and how the law protects you.
            </Paragraph>
          </YStack>
          ...
          <YStack gap="$2">
            ...
            <YStack paddingLeft="$4">
              ...
              <Paragraph>• Develop new products, services, features, and functionality</Paragraph>
              <Paragraph>• Communicate with you, including for customer service, updates, and marketing purposes</Paragraph>
          ...
          <YStack gap="$2">
            ...
            <YStack paddingLeft="$4">
              <Paragraph>• Service providers who perform services on our behalf</Paragraph>
              <Paragraph>• Payment processors for processing donations</Paragraph>
              <Paragraph>• Partners for joint activities or initiatives</Paragraph>
              <Paragraph>• Legal authorities when required by law</Paragraph>
              <Paragraph>• Entities involved in a merger, acquisition, or sale of assets</Paragraph>
            </YStack>
            <Paragraph>
          ...
          <YStack gap="$2">
            ...
            <YStack paddingLeft="$4">
              <Paragraph>• The right to access your personal information</Paragraph>
              <Paragraph>• The right to rectification of inaccurate information</Paragraph>
              <Paragraph>• The right to erasure of your personal information</Paragraph>
              <Paragraph>• The right to restrict processing of your personal information</Paragraph>
              <Paragraph>• The right to data portability</Paragraph>
              <Paragraph>• The right to object to processing of your personal information</Paragraph>
              <Paragraph>• Rights related to automated decision-making and profiling</Paragraph>
            </YStack>
            <Paragraph>
          ...
          <YStack gap="$2">
            ...
            <Paragraph>
              Our website is not intended for children under the age of 13, and we do not knowingly collect personal information from children under 13. If you are a parent or guardian and believe that your child has provided us with personal information, please contact us.
            </Paragraph>
          </YStack>
          ...
          <YStack gap="$2">
            ...
            <Paragraph>
              ...
              <Text
                color="$blue10"
                fontWeight="500"
                onPress={() => Linking.openURL("mailto:privacy@projectwalk2gether.org")}
              >
                privacy@projectwalk2gether.org
              </Text>
            </Paragraph>
            <Paragraph>
              Postal address: [Your organization's physical address]
            </Paragraph>
          </YStack>
          ...
          <YStack gap="$2">
            ...
            <YStack paddingLeft="$4">
              ...
              <Paragraph>• The processing is in our legitimate interests and it's not overridden by your rights</Paragraph>
          ...
          <YStack gap="$2">
            ...
            <YStack paddingLeft="$4">
              <Paragraph>• Know what personal information we collect about you</Paragraph>
              <Paragraph>• Request deletion of your personal information</Paragraph>
              <Paragraph>• Opt-out of the sale of your personal information</Paragraph>
              <Paragraph>• Not be discriminated against for exercising your rights</Paragraph>
            </YStack>
            <Paragraph>
