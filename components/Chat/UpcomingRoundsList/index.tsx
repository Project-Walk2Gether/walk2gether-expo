...
export default function UpcomingRoundsList({ 
  ...
  const handleRotate = async () => {
    ...
    try {
      ...
      await firestore().collection('walks').doc(walkId).collection('rounds').add(roundData);
    ...
    return (
      ...
      >
        ...
        >
          ...
          <Text fontSize="$2" color="$blue8">Only shown to you, the walk owner</Text>
        </XStack>
  ...
  return (
    ...
    >
      ...
      <YStack padding="$2">
        ...
        <YStack padding="$2">
          <Text fontSize="$6" fontWeight="bold" paddingHorizontal="$2" marginBottom="$2">
            Upcoming Rounds
          </Text>
          ...
          {upcomingRounds.map((round, index) => (
            <RoundItem
              ...
              onToggleExpand={() => setExpandedRoundIndex(
