...
/**
 * Component that displays the number of nearby Walk2Gether members
 * Used in location selection and neighborhood walks
 */
const NearbyWalkersInfo: React.FC<Props> = ({
  nearbyWalkers,
